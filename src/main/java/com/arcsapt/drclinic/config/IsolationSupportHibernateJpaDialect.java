...
public class IsolationSupportHibernateJpaDialect extends HibernateJpaDialect {
	...
	public Object beginTransaction(final EntityManager entityManager,
		...
		session.doWork(new Work() {
			@Override
			public void execute(Connection connectionLocal) throws SQLException {
		...
		if (infoEnabled) {
			logger.info("Connection Info: isolationlevel={} , instance={} ",
					connection.getTransactionIsolation(), connection);
			logger.info(
		...
		Object transactionDataFromHibernateJpaTemplate = prepareTransaction(
				entityManager, definition.isReadOnly(), definition.getName());

		return new IsolationSupportSessionTransactionData(
				transactionDataFromHibernateJpaTemplate,
	 ...
	 * 
	 * @see
	 * org.springframework.orm.jpa.vendor.HibernateJpaDialect#cleanupTransaction
	 * (java.lang.Object)
	 */
	@Override
	...
	private static class IsolationSupportSessionTransactionData {
		...
		public IsolationSupportSessionTransactionData(
				Object sessionTransactionDataFromHibernateJpaTemplate,
