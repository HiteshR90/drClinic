...
<!-- header logo: style can be found in header.less -->
        <header class="header">
            <a href="http://www.sharkindia.net/hms/index.html" class="logo">
                                ...
                                <li>
                                    ...
                                    <div style="position: relative; overflow: hidden; width: auto; height: 200px;" class="slimScrollDiv"><ul style="overflow: hidden; width: 100%; height: 200px;" class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="AdminLTE%20_%20Flot%20Charts_files/avatar3.png" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="AdminLTE%20_%20Flot%20Charts_files/avatar2.png" class="img-circle" alt="user image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="AdminLTE%20_%20Flot%20Charts_files/avatar.png" class="img-circle" alt="user image">
                                                </div>
                                                <h4>
                                                    Developers
